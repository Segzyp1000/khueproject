  ...
  return (
    <Layout title="Product List">
      <div className="max-w-6xl mx-auto p-6">
            ...
            >
              ...
              {editingProduct?.id === product.id ? (
                ...
                <>
                  ...
                  <p className="text-red-500 font-bold">{product.stock} left</p>

                  <div className="flex justify-between mt-4">
                    <button
                      onClick={() => handleEdit(product)}
                      className="bg-yellow-500 text-gray-800 px-3 py-1 rounded"
                    >
                      Edit
                    </button>
                    <button
        ...
        {/* Pagination */}
        <div className="flex justify-end items-center gap-2 mt-14">
          <button
